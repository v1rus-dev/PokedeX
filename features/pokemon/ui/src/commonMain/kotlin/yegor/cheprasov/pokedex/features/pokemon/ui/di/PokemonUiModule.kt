...
import yegor.cheprasov.pokedex.features.pokemon.ui.mappers.PokemonStatModelToValueUiModel
...
val pokemonUiModule = module {
    ...
    factoryOf(::PokemonStatsModelToUiModel) {
        bind<Mapper<PokemonStats, PokemonStatsUiModel>>()
    }
    ...
    factoryOf(::PokemonStatModelToValueUiModel) {
        bind<Mapper<PokemonStatModel, PokemonStatValueUiModel>>()
    }
}
